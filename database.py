...
DEFAULT_PLAN_PROMPT = (
    "Составь подробный, структурированный поминутный план на день / стрим-сессию. "
    "Разбей план на последовательные блоки по часам. "
    "В каждом блоке укажи: тему, основные активности, цели и интерактивы."
)
